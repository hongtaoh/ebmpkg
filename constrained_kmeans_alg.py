...
def metropolis_hastings_constrained_kmeans(
    data_we_have,
    iterations,
    n_shuffle,
):
    '''Implement the metropolis-hastings algorithm using constrained kmeans
    Inputs: 
        - data: data_we_have
    ...
    theta_phi_estimates = new_utils.get_theta_phi_estimates(
        data_we_have)
