...
hard_kmeans_dir = os.path.join(base_dir, 'hard_kmeans')
temp_results_dir = os.path.join(hard_kmeans_dir, "temp_json_results")
img_dir = os.path.join(hard_kmeans_dir, 'img')

os.makedirs(hard_kmeans_dir, exist_ok=True)
...
if __name__ == "__main__":
    ...
    accepted_order_dicts = hard_kmeans_alg.metropolis_hastings_hard_kmeans(
        data_we_have,
        iterations,
        n_shuffle,
    )
